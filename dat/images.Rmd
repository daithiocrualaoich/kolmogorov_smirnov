...
calculate_critical_value_wikipedia_95 <- function(n1, n2) {  
  factor = (n1 + n2) / (n1 * n2);
  return (1.36 * sqrt(factor));
}

critical_values$wikipedia <- calculate_critical_value_wikipedia_95(
...
ggplot(critical_values, aes(x=n2, y=wikipedia)) +
